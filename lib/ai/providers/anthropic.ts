...
function buildPrompt(req: GenerateContentRequest): string {
  ...
  const lines = [
    ...
    "",
    "Output JSON schema:",
    `{"variants":[{"text":"...","hashtags":["..."],"aiDisclaimer":"...","nanobananaPrompt":"...","metadata":{"hook":"...","benefit":"...","cta":"..."}}]}`,
    "",
    "Rules:",
    ...
    "- AI Disclaimer: Add a short disclaimer indicating this content was AI-generated (e.g., 'Made with AI' or similar).",
    "- Nanobanana Prompt: Provide a detailed image generation prompt suitable for nanobanana pro based on the caption content. The prompt should describe the visual style, mood, and key elements for an engaging social media image.",
